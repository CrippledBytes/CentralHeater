...
/***  My TCP SERVER APP ****/
#define MY_TCP_SRV_APP_ENABLE       1
...
#define MY_TCP_SRV_APP_LOCAL_PORT     1588   /*The Local TCP Server Port if MT7681 as a TCP server*/

void handle_my_tcp_srv(void);
void proces_data(char data[],int datalen);
#endif
/**************************************************/
/******************TCP CLIENT**********************/
/**************************************************/
