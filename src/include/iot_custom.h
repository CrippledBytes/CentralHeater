...
/*custom AT commands*/
#define		AT_CMD_SEND_TEMP					"Temp "				/*Verzend temperaturen van arduino naar server*/
...
#endif
int16 iot_atcmd_exec_send_temp(puchar pCmdBuf, int16 AtCmdLen) XIP_ATTRIBUTE(".xipsec0");
